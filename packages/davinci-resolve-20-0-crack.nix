  ...
  buildFHSEnv {
    ...
    targetPkgs = pkgs:
      with pkgs;
        ...
        ++
        # Add runtime dependencies from ioPlugins
        (lib.concatLists (builtins.map (drv: drv.runtimeDependencies or []) ioPlugins));
    ...
    extraBwrapArgs =
      ...
      ++ [
        "--ro-bind ${ioPluginsMerged}/IOPlugins ${davinci}/IOPlugins"
      ];
