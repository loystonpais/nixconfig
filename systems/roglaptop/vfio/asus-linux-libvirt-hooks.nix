  ...
  config = {
    virtualisation.libvirtd.hooks.qemu."qemu-nix" = let
      ...
      hooksDir = pkgs.linkFarm "qemu-hooks-dir" {
        "win11/prepare/begin/10-asusd-vfio.sh" = pkgs.writeShellScript "10-asusd-vfio.sh" ''
          source "${vmVarsConf}"
        ...
        "win11/prepare/begin/20-reserve-hugepages.sh" = pkgs.writeShellScript "20-reserve-hugepages.sh" ''
          source "${vmVarsConf}"
        ...
        "win11/prepare/begin/30-set-governor.sh" = pkgs.writeShellScript "30-set-governor.sh" ''
          source "${vmVarsConf}"
        ...
        "win11/prepare/begin/40-isolate-cpus.sh" = pkgs.writeShellScript "40-isolate-cpus.sh" ''
          source "${vmVarsConf}"
        ...
        "win11/release/end/10-release-hugepages.sh" = pkgs.writeShellScript "10-release-hugepages.sh" ''
          source "${vmVarsConf}"
        ...
        "win11/release/end/20-return-cpus.sh" = pkgs.writeShellScript "20-return-cpus.sh" ''
          source "${vmVarsConf}"
        ...
        "win11/release/end/30-restore-governor.sh" = pkgs.writeShellScript "30-restore-governor.sh" ''
          source "${vmVarsConf}"
