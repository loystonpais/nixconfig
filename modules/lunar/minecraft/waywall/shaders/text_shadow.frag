...
const vec4 text_color = RGBA8(0.0, 0.0, 0.0, 0.85);
const vec4 entity_color = RGBA8(40.0, 10.0, 35.0, 0.9);
const vec4 unspecified_color = RGBA8(10.0, 40.0, 20.0, 0.9);
const vec4 blockentities_color = RGBA8(45.0, 20.0, 15.0, 0.9);
const vec4 mobspawner_color = RGBA8(10.0, 45.0, 40.0, 0.9);
