{
  ...
  lunar.plasma = {
    nixos = {pkgs, ...}: {
      ...
      environment.plasma6.excludePackages = with pkgs.kdePackages; [baloo];
    ...
    homeManager = {pkgs, ...}: {
      ...
      programs.plasma = {
        ...
        configFile = {
          ...
          "kwinrc"."org.kde.kdecoration2"."ButtonsOnRight" = "FBIAX";
        };
      };
    ...
    provides.mac-look = {mode ? "mac", ...}: {
      ...
      nixos = {
        ...
        # ?
        # lunar.modules.sddm.enable = lib.mkDefault true;
      };
